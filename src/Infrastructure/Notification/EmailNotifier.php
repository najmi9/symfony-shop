...
class EmailNotifier implements EmailNotifierInterface
{
    ...
    public function __construct(MailerInterface $mailer, string $sender_email, Environment $twig, /* string $dkimKey, */ EnqueueMethod $enqueue)
    {
        $this->mailer = $mailer;
